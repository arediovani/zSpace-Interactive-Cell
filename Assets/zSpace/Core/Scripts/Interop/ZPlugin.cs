...
namespace zSpace.Core.Interop
{
    public static class ZPlugin
    {
        ...
        /// <summary>
        /// Sets the zCore native plugin context to use on the Unity render
        /// thread.
        /// </summary>
        /// 
        /// <param name="context">
        /// A handle to a zCore native plugin context.
        /// </param>
        [DllImport(
            DllName, 
            EntryPoint = "zcuSetRenderThreadContext", 
            CallingConvention = CallingConvention.StdCall)]
        internal static extern ZPluginError SetRenderThreadContext(
            IntPtr context);
        ...
        /// A handle to the internal state of the zSpace SDK.
        /// </param>
        /// <param name="isRunningOnSRDevice">
        /// True if running on an SR device, false otherwise.
        /// </param>
        [DllImport(
            DllName, 
            EntryPoint = "zcuIsRunningOnSRDevice", 
            CallingConvention = CallingConvention.StdCall)]
        internal static extern ZPluginError IsRunningOnSRDevice(
            IntPtr context, 
            [param: MarshalAs(UnmanagedType.Bool), Out()]
            out bool isRunningOnSRDevice);
#endif
        ...
        /// <summary>
        /// Gets the render mode requested for the current zSpace hardware.
        /// </summary>
        /// 
        /// <param name="context">
        /// A handle to the internal state of the zSpace SDK.
        ...
        /// The requested render mode.
        /// </param>
        [DllImport(
            DllName, 
            EntryPoint = "zcuGetStereoDisplayMode", 
            CallingConvention = CallingConvention.StdCall)]
        internal static extern ZPluginError GetStereoDisplayMode(
            IntPtr context, 
            out ZStereoDisplayMode stereoDisplayMode);

        /// <summary>
        /// Sets whether or not displaying stereo is enabled.
        /// </summary>
        /// 
        /// <param name="context">
        /// A handle to a zCore native plugin context.
        ...
        /// True if displaying stereo should be enabled, false otherwise.
        /// </param>
        [DllImport(
            DllName, 
            EntryPoint = "zcuSetStereoDisplayEnabled", 
            CallingConvention = CallingConvention.StdCall)]
        internal static extern ZPluginError SetStereoDisplayEnabled(
            IntPtr context, 
            [param: MarshalAs(UnmanagedType.Bool)]
            bool isEnabled);

        /// <summary>
        /// Gets whether or not displaying stereo is enabled.
        /// </summary>
        /// 
        /// <param name="context">
        /// A handle to a zCore native plugin context.
        /// </param>
        /// <param name="isEnabled">
        /// True if display stereo is enabled, false otherwise.
        /// </param>
        [DllImport(
            DllName, 
            EntryPoint = "zcuIsStereoDisplayEnabled", 
            CallingConvention = CallingConvention.StdCall)]
        internal static extern ZPluginError IsStereoDisplayEnabled(
            IntPtr context, 
            [param: MarshalAs(UnmanagedType.Bool), Out()]
            out bool isEnabled);

        /// <summary>
        /// Gets whether or not the application needs to tie the stereo display
        ...
        /// A handle to a zCore native plugin context.
        /// </param>
        /// <param name="mustTieStereoDisplayEnabledToApplicationFocus">
        /// True if application must tie stereo display enabled state to
        /// application focus state.
        /// </param>
        ///
        /// <remarks>
        /// When the mustTieStereoDisplayEnabledToApplicationFocus output
        /// argument is true, the application must use
        /// zcuSetStereoDisplayEnabled() to set the stereo display enabled
        /// state to true when the application is focused and to false when the
        /// application is not focused.
        /// </remarks>
        [DllImport(
            DllName, 
            EntryPoint = "zcuGetMustTieStereoDisplayEnabledToApplicationFocus", 
            CallingConvention = CallingConvention.StdCall)]
        internal static extern ZPluginError
            GetMustTieStereoDisplayEnabledToApplicationFocus(
                IntPtr context, 
                [param: MarshalAs(UnmanagedType.Bool), Out()]
                out bool mustTieStereoDisplayEnabledToApplicationFocus);
        ...
        /// <summary>
        /// Get the primary stereo viewport.
        /// </summary>
        /// 
        /// <param name="context">
        /// A handle to the internal state of the zSpace SDK.
        ...
        [DllImport(
            DllName, 
            EntryPoint = "zcuGetPrimaryViewport", 
            CallingConvention = CallingConvention.StdCall)]
        internal static extern ZPluginError GetPrimaryViewport(
            IntPtr context, 
        ...
        /// <summary>
        /// Sets the frustum's left and right eye poses in tracker space.
        /// </summary>
        /// 
        /// <param name="frustumHandle">
        /// A handle to the frustum.
        /// </param>
        /// <param name="leftEyePose">
        /// The desired left eye pose.
        /// </param>
        /// <param name="rightEyePose">
        /// The desired right eye pose.
        /// </param>
        [DllImport(
            DllName, 
            EntryPoint = "zcuSetFrustumTrackerSpaceEyePoses", 
            CallingConvention = CallingConvention.StdCall)]
        internal static extern ZPluginError SetFrustumTrackerSpaceEyePoses(
            IntPtr frustumHandle, 
            [param: MarshalAs(UnmanagedType.LPStruct)]
            ZPose leftEyePose,
            [param: MarshalAs(UnmanagedType.LPStruct)]
        ...
        /// <summary>
        /// Gets the frustum's current left and right eye poses in tracker
        /// space.
        /// </summary>
        /// 
        /// <param name="frustumHandle">
        ...
        /// </param>
        /// <param name="leftEyePose">
        /// The current left eye pose.
        /// </param>
        /// <param name="rightEyePose">
        /// The current right eye pose.
        /// </param>
        [DllImport(
            DllName, 
            EntryPoint = "zcuGetFrustumTrackerSpaceEyePoses", 
            CallingConvention = CallingConvention.StdCall)]
        internal static extern ZPluginError GetFrustumTrackerSpaceEyePoses(
            IntPtr frustumHandle,
            out ZPose leftEyePose,
            out ZPose rightEyePose);
        ...
        [DllImport(
            DllName, 
            EntryPoint = "zcuGetPerEyeImageResolution",
            CallingConvention = CallingConvention.StdCall)]
        internal static extern ZPluginError
        ...
        [DllImport(
            DllName,
            EntryPoint = "zcuBeginFrame",
            CallingConvention = CallingConvention.StdCall)]
        internal static extern ZPluginError BeginFrame(IntPtr context); 

        [DllImport(
            DllName,
            EntryPoint = "zcuEndFrame",
            CallingConvention = CallingConvention.StdCall)]
        internal static extern ZPluginError EndFrame(IntPtr context); 

        [DllImport(
            DllName,
            EntryPoint = "zcuSetStereoDisplayTextures",
            CallingConvention = CallingConvention.StdCall)]
        internal static extern ZPluginError SetStereoDisplayTextures(
            IntPtr leftTexturePtr, 
            IntPtr rightTexturePtr,
            [param: MarshalAs(UnmanagedType.Bool)]
            bool areTexturesSRGB);

        [DllImport(
            DllName,
            EntryPoint = "zcuSetStereoDisplayTexturesV2",
            CallingConvention = CallingConvention.StdCall)]
        internal static extern ZPluginError SetStereoDisplayTexturesV2(
            IntPtr leftTexturePtr, 
            IntPtr rightTexturePtr,
            uint textureDXGIFormat);

        [DllImport(
            DllName,
            EntryPoint = "zcuSetStereoDisplayRenderTargetSRGBConversionEnabled",
            CallingConvention = CallingConvention.StdCall)]
        internal static extern ZPluginError
            SetStereoDisplayRenderTargetSRGBConversionEnabled(bool isEnabled);

        [DllImport(
            DllName, 
            EntryPoint = "zcuIsXROverlaySupported", 
            CallingConvention = CallingConvention.StdCall)]
        internal static extern ZPluginError IsXROverlaySupported(
            IntPtr context, 
            [param: MarshalAs(UnmanagedType.Bool), Out()]
        ...
        [DllImport(
            DllName, 
            EntryPoint = "zcuGetWindowPhysicalRect",
            CallingConvention = CallingConvention.StdCall)]
        internal static extern ZPluginError
            GetWindowPhysicalRect(
                IntPtr windowHandle, 
                ref int physicalLeft,
                ref int physicalTop,
                ref int physicalRight,
                ref int physicalBottom);

        [DllImport(
            DllName, 
            EntryPoint = "zcuGetWindowScaleFactorPercentage",
            CallingConvention = CallingConvention.StdCall)]
        internal static extern ZPluginError
            GetWindowScaleFactorPercentage(
                IntPtr windowHandle, ref int scaleFactorPercentage);
